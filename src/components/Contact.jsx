  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Miracle Okeke",
          from_email: form.email,
          to_email: "mokeke185@gmail.com",
      ...
      >
        ...
        <div className=" xs:bottom-10 bottom-32 w-full flex justify-star">
          <div className="flex mt-4 gap-4 ">
            <a
              href="https://twitter.com/mconcept8?lang=en"
              target="_blank"
            ...
            <a
              href="mailto:mokeke185@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
            >
...
// Exporting the Contact component wrapped with SectionWrapper
